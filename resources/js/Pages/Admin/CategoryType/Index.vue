...
const destroy = reactive({
    ...
    submit: () => {
        formDelete.delete(route("category.destroy", destroy.id))
    }
})
</script>
        ...
        <SectionMain>
            ...
            <CardBox class="mb-6" has-table>
                <table>
                    ...
                    <tbody>
                    <tr v-for="category in category_types.data" :key="category.id">
                        <td data-label="Name">
                            {{ category.name }}
                        </td>
                        ...
                        >
                            <BaseButtons type="justify-start lg:justify-end" no-wrap>
                                ...
                                <BaseButton
                                    ...
                                    :icon="mdiTrashCan"
                                    small
                                    @click="destroy.confirm(category.id)"
                                />
                            </BaseButtons>
                        </td>
                    </tr>
                ...
                <div class="py-4">
                    <Pagination :data="category_types"/>
                </div>
            </CardBox>
        </SectionMain>
    </LayoutAuthenticated>
